...
public class Ambulance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Ambulance.BackgroundTask().execute();
...
//                    float dist = getLocationDist(latlong[1],latlong[2]);
                ...
                recyclerView.setAdapter(new MyAdapter(Ambulance.this, names, addresses, contacts, distance, emails, type, speciality) {
                    @Override
                    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
                        ...
                        viewHolder.layout.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                i.setData(Uri.parse("tel:"+contacts.get(pos)));
                                if (ActivityCompat.checkSelfPermission(Ambulance.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                                    ActivityCompat.requestPermissions(Ambulance.this,new String[]{Manifest.permission.CALL_PHONE},100);
                                    Toast.makeText(Ambulance.this,"Please grant all permissions first",Toast.LENGTH_LONG).show();
                                    return;
                                }
                                startActivity(i);
                            }
                ...
                Toast.makeText(Ambulance.this, e.getMessage(), Toast.LENGTH_LONG).show();
            }
        }
